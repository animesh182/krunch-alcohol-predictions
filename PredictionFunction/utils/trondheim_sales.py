...
def sales_without_effect(
    ...
    average_sales_new_alcohol = (
        actual_sales_alcohol.groupby(["gastronomic_day", "article_supergroup"])[
            "total_net"
        ]
        .sum()
        .reset_index()
    ...
    average_sales_new_food = (
        actual_sales_food.groupby(["gastronomic_day", "article_supergroup"])[
            "total_net"
        ]
        .sum()
        .reset_index()
    ...
    final_sales_grouped = (
        final_scaled_scales.groupby(["gastronomic_day", "article_supergroup"])[
            "total_net"
        ]
        .sum()
        .reset_index()
    ...
    actual_trondheim_sales_grouped = (
        actual_trondheim_sales.groupby(["gastronomic_day", "article_supergroup"])[
            "total_net"
        ]
        .sum()
        .reset_index()
